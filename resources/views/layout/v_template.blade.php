...
<head>
    ...
    <meta charset="utf-8" />
    <title>Litapdimas - IAIN Palangka Raya</title>
    ...
    <!-- dropzone css -->
    <link href="{{ asset('template') }}/assets/libs/dropzone/min/dropzone.min.css" rel="stylesheet" type="text/css" />
...
<body data-layout="horizontal" data-topbar="colored">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user" src="{{ asset('template') }}/assets/images/users/avatar-4.jpg"
                                alt="Header Avatar">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="index.html">
                                        <i class="uil-home-alt me-2"></i> Beranda
                                    </a>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement"
                                        role="button">
                                        <i class="uil-flask me-2"></i>Informasi <div class="arrow-down"></div>
                                    </a>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-pages"
                                        role="button">
                                        <i class="uil-apps me-2"></i>Data & Persetujuan <div class="arrow-down"></div>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                                ...
                                                <a href="ecommerce-add-product.html" class="dropdown-item">Add
                                                    Product</a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components"
                                        role="button">
                                        <i class="uil-layers me-2"></i>Proposal <div class="arrow-down"></div>
                                    </a>
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by <a
                                    href="#" class="text-reset">Muhammad Nur Effendi</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- dropzone plugin -->
    <script src="{{ asset('template') }}/assets/libs/dropzone/min/dropzone.min.js"></script>

    <!-- init js -->
    <script src="{{ asset('template') }}/assets/js/pages/ecommerce-add-product.init.js"></script>

    <!-- form repeater js -->
    <script src="{{ asset('template') }}/assets/libs/jquery.repeater/jquery.repeater.min.js"></script>

    <script src="{{ asset('template') }}/assets/js/pages/form-repeater.int.js"></script>
...
<!-- Mirrored from themesbrand.com/minible/layouts/layouts-horizontal.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Nov 2021 11:44:53 GMT -->
