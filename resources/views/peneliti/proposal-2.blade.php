    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="addproduct-accordion" class="custom-accordion">
                ...
                <div class="card">
                    <a href="#addproduct-billinginfo-collapse" class="text-dark collapsed"
                    ...
                    <div id="addproduct-billinginfo-collapse" class="collapse"
                ...
                <div class="card">
                    <a href="#addproduct-img-collapse" class="text-dark"
                ...
                <div class="card">
                    <a href="" class="text-dark collapsed"
